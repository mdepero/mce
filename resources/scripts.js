...
function addForms(){
  ...
  $.each( $('input[name="students"]:checked'), function(index, text) {
    ...
    $("#forms").append(
        "<p><h2>" + students[$(text).val()] + "</h2>"+'<input type="hidden" name="id[]" value="'+$(text).val()+'"'+'<p>1 2 3 4 5<br /><input type="radio" name="1[]" value="1"><input type="radio" name="1[]" value="2"><input type="radio" name="1[]" value="3"><input type="radio" name="1[]" value="4"><input type="radio" name="1[]" value="5"> Test Field Number One<br /><input type="radio" name="1[]" value="1"><input type="radio" name="1[]" value="2"><input type="radio" name="1[]" value="3"><input type="radio" name="1[]" value="4"><input type="radio" name="1[]" value="5"> Test Field Number Two<br /> <input type="radio" name="1[]" value="1"><input type="radio" name="1[]" value="2"><input type="radio" name="1[]" value="3"><input type="radio" name="1[]" value="4"><input type="radio" name="1[]" value="5">Test Field Number Three<br /></p></p>'
      );
